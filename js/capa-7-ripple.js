/* ============================================================================
 * CAPA 7 · ONDA AL TOCAR (ripple)  (parte JS · SEP AGENDA)
 * ----------------------------------------------------------------------------
 * QUÉ HACE
 ...
 *   · La rueda de cupos no entra: se arrastra, y una onda por roce sería ruido.
...
(function () {
  ...
  var SEL = '.btn, .iosp-btn, .tb-logout, .btn-meet';
  var MAX_MS = 700;
