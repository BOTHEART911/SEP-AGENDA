  ...
  function item(d) {
    ...
    return '' +
      ...
      /* FASE 4.1 · punto 2 — "No disponible todavía" ya no es un
         ...
         y que todavía no corresponde pedirlo, con la fecha cuando la
         condición de apertura es por fecha. El texto lo manda el
         backend (condición de apertura de ESE documento). */
      (d.estado === 'NO_DISPONIBLE' && !d.auto && !d.soloVer
        ? '  <p class="muted" style="margin:10px 0 0">Este documento hace parte de tu proceso, ' +
          'pero todavía no corresponde pedirlo. ' +
